...
<head>
    ...
    <title>ðŸŽ° 4pu3$t4$_Qva Â· Tu Casa de Apuestas</title>
...
<div id="app" class="max-w-4xl mx-auto relative">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="glass-card px-3 py-2 balance-container">
            ...
            <span class="balance-secondary" id="quickBalanceUsd">â‰ˆ 0.00 USD</span>
        </div>
    </div>
    ...
    <div id="globalLoader" class="flex justify-center items-center py-20">
        ...
        <p class="ml-3 text-sm text-gray-300">Cargando aplicaciÃ³n...</p>
    </div>
        ...
        <div id="sectionsContainer" class="mt-4 mb-24">
            ...
            <div id="section-home" class="section active-section">
                <div class="glass-card p-6 text-center">
                    ...
                    <h2 class="text-3xl font-bold neon-text mb-2">Â¡Bienvenido!</h2>
                    <p class="text-gray-200 mb-6">Selecciona una opciÃ³n en el menÃº inferior para comenzar a jugar y ganar.</p>
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="bg-white/20 p-4 rounded-2xl backdrop-blur-sm">
                            ...
                            <p class="font-bold">ComisiÃ³n referidos</p>
            ...
            <div id="section-play" class="section hidden-section">
                <div class="glass-card p-5">
                    <h3 class="text-2xl font-bold mb-4 flex items-center"><i class="fas fa-clock mr-3 text-cyan-300"></i>Elige loterÃ­a</h3>
                    <div class="grid grid-cols-3 gap-3 mb-4">
                        <button data-lottery="Florida" class="lottery-btn bg-gradient-to-br from-red-500 to-orange-500 p-4 rounded-2xl shadow-lg hover:scale-105 transition flex flex-col items-center">
                            <span class="text-4xl mb-2 lottery-emoji">ðŸ¦©</span>
                    ...
                    <div id="betTypeContainer" class="hidden">
                        ...
                        <div class="grid grid-cols-2 gap-3 mb-4">
                            <button data-type="fijo" class="type-btn bg-blue-600/80 p-3 rounded-xl hover:bg-blue-700">ðŸŽ¯ Fijo</button>
                            <button data-type="corridos" class="type-btn bg-green-600/80 p-3 rounded-xl hover:bg-green-700">ðŸƒ Corridos</button>
                            <button data-type="centena" class="type-btn bg-purple-600/80 p-3 rounded-xl hover:bg-purple-700">ðŸ’¯ Centena</button>
                            <button data-type="parle" class="type-btn bg-yellow-600/80 p-3 rounded-xl hover:bg-yellow-700">ðŸ”’ Parle</button>
                        </div>
                    </div>

                    <div id="betFormContainer" class="hidden">
                        <div id="betInstructions" class="text-sm bg-gray-800/70 p-3 rounded-xl mb-3"></div>
                        <label class="block mb-2 font-medium">âœï¸ Escribe tus jugadas (una por lÃ­nea):</label>
            ...
            <div id="section-wallet" class="section hidden-section">
                <div class="glass-card p-5">
                    <h3 class="text-2xl font-bold mb-4">ðŸ’° Mi saldo</h3>
                    
                    <div class="balance-grid">
                        <div class="balance-card">
                            <p class="text-sm opacity-90">ðŸ‡¨ðŸ‡º CUP</p>
                            <p id="walletCup" class="text-2xl font-bold">0.00</p>
                            <p class="text-xs text-gray-300">(principal)</p>
                        </div>
                        <div class="balance-card">
                            <p class="text-sm opacity-90">ðŸ’µ USD</p>
                            <p id="walletUsd" class="text-2xl font-bold">0.00</p>
                            <p id="walletUsdEquivalent" class="text-xs text-gray-300">(â‰ˆ 0.00 CUP)</p>
                        </div>
                    </div>

                    <div class="bg-blue-900/50 p-4 rounded-2xl text-center mb-4">
                        <p class="text-sm">ðŸŽ Bono (no retirable)</p>
                    ...
                    <div id="withdrawTimeInfo" class="bg-gray-800/50 p-3 rounded-xl text-xs text-center text-gray-300 mb-2">
                        ...
                        Los retiros estÃ¡n disponibles de <strong>10:00 PM a 11:30 PM</strong> (hora Cuba). 
                        <span id="withdrawTimeStatus" class="withdraw-time-status"></span>
                    </div>

                    <!-- RECARGA -->
                    <div id="rechargeSection" class="hidden mt-6">
                        <h4 class="text-lg font-semibold mb-3">ðŸ“¥ Recargar saldo</h4>
                    ...
                    <div id="withdrawSection" class="hidden mt-6">
                        <h4 class="text-lg font-semibold mb-3">ðŸ“¤ Retirar saldo</h4>
                        ...
                        <!-- Campos dinÃ¡micos para datos de cuenta -->
                    ...
                    <div id="transferSection" class="hidden mt-6">
                        <h4 class="text-lg font-semibold mb-3">ðŸ”„ Transferir saldo</h4>
                        <p class="text-xs text-gray-400 mb-2">âš ï¸ Solo puedes transferir CUP o USD. El bono de bienvenida no es transferible.</p>
            ...
            <!-- SECCIÃ“N MIS JUGADAS -->
            <div id="section-bets" class="section hidden-section">
                <div class="glass-card p-5">
                    <h3 class="text-2xl font-bold mb-4">ðŸ“‹ Historial de apuestas</h3>
            ...
            <div id="section-referrals" class="section hidden-section">
                <div class="glass-card p-5">
                    <h3 class="text-2xl font-bold mb-4">ðŸ‘¥ Invita y gana</h3>
                    <div class="bg-gradient-to-r from-yellow-600/30 to-pink-600/30 p-5 rounded-2xl text-center mb-4">
                        ...
                        <p class="text-lg font-bold">Â¡Gana comisiÃ³n de por vida!</p>
            ...
            <div id="section-admin" class="section hidden-section">
                <div class="glass-card p-5">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
                        ...
                        <button data-admin-view="addDeposit" class="admin-nav-btn bg-blue-600/80 p-3 rounded-xl hover:bg-blue-700"><i class="fas fa-plus mr-1"></i> AÃ±adir DepÃ³sito</button>
                        <button data-admin-view="addWithdraw" class="admin-nav-btn bg-pink-600/80 p-3 rounded-xl hover:bg-pink-700"><i class="fas fa-plus mr-1"></i> AÃ±adir Retiro</button>
                        <button data-admin-view="editDeposit" class="admin-nav-btn bg-indigo-400/80 p-3 rounded-xl hover:bg-indigo-500"><i class="fas fa-edit mr-1"></i> Editar DepÃ³sito</button>
                        ...
                        <button data-admin-view="deleteDeposit" class="admin-nav-btn bg-red-600/80 p-3 rounded-xl hover:bg-red-700"><i class="fas fa-trash mr-1"></i> Eliminar DepÃ³sito</button>
                        ...
                        <button data-admin-view="setPrices" class="admin-nav-btn bg-purple-600/80 p-3 rounded-xl hover:bg-purple-700"><i class="fas fa-dice mr-1"></i> Pagos, MÃ­n y MÃ¡x</button>
...
<script>
    (function() {
        ...
        // ---------- CONFIGURACIÃ“N DE HORARIOS POR LOTERÃA (hora de Cuba) ----------
        const LOTTERY_SCHEDULES = {
            'Florida': [
                { name: 'ðŸŒ… MaÃ±ana', start: 9, end: 13 },
                { name: 'ðŸŒ™ Noche', start: 14, end: 21 }
            ],
            'Georgia': [
                { name: 'ðŸŒ… MaÃ±ana', start: 9, end: 12 },
                { name: 'â˜€ï¸ Tarde', start: 14, end: 18.5 },
                { name: 'ðŸŒ™ Noche', start: 20, end: 23 }
            ],
            'Nueva York': [
                { name: 'ðŸŒ… MaÃ±ana', start: 9, end: 14 },
                { name: 'ðŸŒ™ Noche', start: 15, end: 22 }
            ]
        };
        ...
        function updateWithdrawTimeStatus() {
            ...
            withdrawTimeStatus.innerHTML = available ? 'âœ… Disponible ahora' : 'âŒ No disponible (horario: 10:00 PM - 11:30 PM)';
        ...
        // Verificar horario de loterÃ­as
        function checkLotterySchedule(lottery) {
            ...
            let scheduleText = `ðŸ•’ <b>Horarios ${lottery}:</b><br>`;
            scheduleText += slots.map(s => {
                ...
                return `${s.name} (${startStr}â€“${endStr})`;
            }).join(' â€¢ ');
            if (active) {
                scheduleText += `<br><span class="text-green-400">âœ… Ahora puedes jugar en el turno <b>${active}</b></span>`;
            } else {
                scheduleText += `<br><span class="text-red-400">â° <b>Fuera de horario</b> Â· Intenta en el horario permitido</span>`;
            }
        ...
        document.querySelectorAll('.lottery-btn').forEach(btn => {
            btn.addEventListener('click', async () => {
                ...
                if (!activeSlot) {
                    sessionStatus.innerHTML = `<span class="text-red-400">âŒ No hay turno disponible ahora. Revisa los horarios ðŸ‘†</span>`;
                ...
                try {
                    ...
                    if (session && session.id && session.status === 'open') {
                        ...
                        sessionStatus.innerHTML = `<span class="text-green-400">âœ… Turno <b>${activeSlot}</b> abierto Â· Cierre: ${new Date(session.end_time).toLocaleTimeString()}</span>`;
                        sessionStatus.classList.remove('hidden');
                        betTypeContainer.classList.remove('hidden');
                    } else {
                        activeSession = null;
                        sessionStatus.innerHTML = `<span class="text-yellow-400">âš ï¸ El turno <b>${activeSlot}</b> no estÃ¡ abierto. Contacta al administrador.</span>`;
                        sessionStatus.classList.remove('hidden');
                        betTypeContainer.classList.add('hidden');
                    }
                } catch (e) {
                    console.error(e);
                    iziToast.error({ message: 'Error al verificar sesiÃ³n' });
                }
            });
        });
        ...
        document.querySelectorAll('.type-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                if (!activeSession) {
                    iziToast.warning({ message: 'No hay sesiÃ³n activa para esta loterÃ­a' });
                    return;
                }
        ...
        async function updateBetInstructions() {
            ...
            const maxCup = price.max_cup !== null ? price.max_cup : 'âˆž';
            const maxUsd = price.max_usd !== null ? price.max_usd : 'âˆž';

            let instructions = '';
            switch (selectedBetType) {
                case 'fijo':
                    instructions = `ðŸŽ¯ <b>FIJO</b> â€“ NÃºmero de 2 dÃ­gitos. Usa "D" para decena o "T" para terminal.<br>Ej: 12 con 1 usd, D2 con 5 usd, T5*1cup<br>Varios nÃºmeros por lÃ­nea: 10 02 78 90 87 con 10 cup`;
                    break;
                case 'corridos':
                    instructions = `ðŸƒ <b>CORRIDOS</b> â€“ NÃºmero de 2 dÃ­gitos. Ej: 17 con 0.5 usd, 32 con 10 cup<br>Varios: 17 32 45 con 5 cup`;
                    break;
                case 'centena':
                    instructions = `ðŸ’¯ <b>CENTENA</b> â€“ NÃºmero de 3 dÃ­gitos. Ej: 517 con 2 usd, 019*1 usd<br>Varios: 517 019 123 con 2 usd`;
                    break;
                case 'parle':
                    instructions = `ðŸ”’ <b>PARLE</b> â€“ Dos nÃºmeros de 2 dÃ­gitos separados por "x". Ej: 17x32 con 1 usd, 17x62*2 usd<br>Varios: 17x32 17x62 32x62 con 5 cup`;
                    break;
            }
            instructions += `<br><br>ðŸ’° <b>Pago:</b> x${multiplier}<br>ðŸ“‰ <b>MÃ­n:</b> ${minCup} CUP / ${minUsd} USD<br>ðŸ“ˆ <b>MÃ¡x:</b> ${maxCup} CUP / ${maxUsd} USD`;
        ...
        betInput.addEventListener('input', function() {
            ...
            if (parsed.ok) {
                ...
                betPreview.innerHTML = `ðŸ’° Total: ${totalCUP.toFixed(2)} CUP / ${totalUSD.toFixed(2)} USD<br>${totalCUP > 0 ? `(equivale a ${cupEquivalentUsd} USD)` : ''} ${totalUSD > 0 ? `(equivale a ${usdEquivalentCup} CUP)` : ''}`;
            } else {
                betPreview.innerHTML = 'âŒ Formato no vÃ¡lido';
            }
        });

        submitBetBtn.addEventListener('click', async () => {
            if (!activeSession) { iziToast.error({ message: 'No hay sesiÃ³n activa' }); return; }
            const rawText = betInput.value.trim();
            if (!rawText || !selectedBetType) { iziToast.warning({ message: 'Escribe tus jugadas' }); return; }
            
            const parsed = parseBetMessage(rawText, selectedBetType);
            if (!parsed.ok) {
                iziToast.warning({ message: 'Formato de jugada invÃ¡lido' });
                return;
            }
            ...
            try {
                ...
                if (res.ok) {
                    iziToast.success({ title: 'âœ… Jugada registrada', message: 'Â¡Buena suerte!' });
                ...
                console.error(e);
                iziToast.error({ message: 'Error de conexiÃ³n' });
            }
        });
            ...
            try {
                ...
                globalLoader.innerHTML = `
                    <div class="error-box">
                        ...
                        <p class="text-xl font-bold mb-2">Error de conexiÃ³n</p>
                        <p class="text-sm mb-4">${e.message || 'No se pudo cargar la sesiÃ³n.'}</p>
        ...
        function updateBalanceUI() {
            ...
            document.getElementById('quickBalanceUsd').innerText = `â‰ˆ ${(cup / exchangeRates.rate).toFixed(2)} USD`;
            
            document.getElementById('walletCup').innerText = cup.toFixed(2);
            document.getElementById('walletUsd').innerText = usd.toFixed(2);
            document.getElementById('walletUsdEquivalent').innerText = `â‰ˆ ${(usd * exchangeRates.rate).toFixed(2)} CUP`;
        ...
        async function loadDepositMethods() {
            try {
                ...
                if (select) {
                    select.innerHTML = '<option value="">Selecciona mÃ©todo...</option>';
                    ...
                    if (methodId) {
                        ...
                        if (method) {
                            depositMethodInfo.innerHTML = `
                                ...
                                <p>ðŸ“± Datos: <code>${escapeHTML(method.card)}</code></p>
                                <p>âœ… Confirmar: <code>${escapeHTML(method.confirm)}</code></p>
                            `;
                            depositMethodInfo.classList.remove('hidden');
                            let limitsHtml = '';
                            if (method.min_amount !== null || method.max_amount !== null) {
                                limitsHtml = '<span class="font-semibold">LÃ­mites:</span> ';
                                if (method.min_amount !== null) limitsHtml += `MÃ­n: ${method.min_amount} ${method.currency} `;
                                if (method.max_amount !== null) limitsHtml += `MÃ¡x: ${method.max_amount} ${method.currency}`;
                ...
                iziToast.error({ message: 'Error al cargar mÃ©todos de depÃ³sito' });
            }
        }
        ...
        async function loadWithdrawMethods() {
            try {
                ...
                select.addEventListener('change', function() {
                    ...
                    if (methodId) {
                        ...
                        if (method) {
                            ...
                            if (method.min_amount !== null || method.max_amount !== null) {
                                limitsHtml = '<span class="font-semibold">LÃ­mites:</span> ';
                                if (method.min_amount !== null) limitsHtml += `MÃ­n: ${method.min_amount} ${currency} `;
                                if (method.max_amount !== null) limitsHtml += `MÃ¡x: ${method.max_amount} ${currency}`;
                                withdrawMethodLimits.innerHTML = limitsHtml;
                            } else {
                                withdrawMethodLimits.innerHTML = '';
                            }

                            // Mostrar campos dinÃ¡micos segÃºn moneda
                ...
                iziToast.error({ message: 'Error al cargar mÃ©todos de retiro' });
            }
        }
        ...
        function renderWithdrawFields(method) {
            ...
            if (currency === 'USDT' || currency === 'TRX') {
                ...
                html = `
                    <div>
                        <label class="block text-sm font-medium mb-1">DirecciÃ³n de wallet</label>
                        <input type="text" id="withdrawWallet" placeholder="${escapeHTML(method.card) || 'DirecciÃ³n de wallet'}" class="w-full p-3 rounded-xl bg-gray-800 text-white border border-pink-500">
                    </div>
                    <div>
                ...
                // Fiat: dos campos personalizados (tarjeta y confirmaciÃ³n)
                html = `
                    <div>
                        <label class="block text-sm font-medium mb-1">NÃºmero de tarjeta / cuenta</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-1">NÃºmero a confirmar</label>
        ...
        function renderBetsList(bets) {
            ...
            if (!bets || bets.length === 0) {
                container.innerHTML = '<p class="text-gray-400 text-center py-4">No tienes jugadas aÃºn.</p>';
                return;
            }
            ...
            bets.forEach(b => {
                ...
                html += `<div class="bg-gray-800/50 p-3 rounded-xl bet-item" onclick="showBetDetail(${b.id})">
                    <div class="flex justify-between items-center">
                        <div>
                            <span class="font-bold">ðŸŽ° ${b.lottery} - ${b.bet_type}</span>
        ...
        window.showBetDetail = async (betId) => {
            ...
            const actionsHtml = sessionOpen ? `
                <div class="flex gap-2 mt-4">
                    <button onclick="editBet(${bet.id})" class="flex-1 bg-blue-600 py-2 rounded-lg edit-cancel-btn">âœï¸ Editar</button>
                    <button onclick="cancelBet(${bet.id})" class="flex-1 bg-red-600 py-2 rounded-lg edit-cancel-btn">ðŸ—‘ Cancelar</button>
                </div>
            ` : '';

            betDetailModalBody.innerHTML = `
                <h4 class="text-xl font-bold mb-2">Detalles de la jugada</h4>
                <p class="text-sm text-gray-300 mb-1">ðŸŽ° ${bet.lottery} - ${bet.bet_type}</p>
                <p class="text-xs text-gray-400 mb-3">${new Date(bet.placed_at).toLocaleString()}</p>
                
                <div class="mb-3">
                    <p class="font-semibold mb-1">ðŸ“ NÃºmeros jugados:</p>
                    ${itemsHtml}
                </div>
        ...
        window.cancelBet = async (betId) => {
            if (!confirm('Â¿EstÃ¡s seguro de cancelar esta jugada? Se te reembolsarÃ¡ el monto.')) return;
        ...
        document.getElementById('submitDepositBtn').addEventListener('click', async () => {
            ...
            if (!parsed) {
                iziToast.warning({ message: 'Formato invÃ¡lido. Ej: 500 cup, 10 usdt, 100 trx' });
                return;
            }
            ...
            if (method.currency !== parsed.currency) {
                iziToast.warning({ message: `Este mÃ©todo es en ${method.currency}, no coincide con el monto.` });
                return;
            }

            if (method.min_amount !== null && parsed.amount < method.min_amount) {
                iziToast.warning({ message: `Monto mÃ­nimo: ${method.min_amount} ${method.currency}` });
                return;
            }
            if (method.max_amount !== null && parsed.amount > method.max_amount) {
                iziToast.warning({ message: `Monto mÃ¡ximo: ${method.max_amount} ${method.currency}` });
                return;
            }
            ...
            } catch (e) { iziToast.error({ message: 'Error de conexiÃ³n' }); }
        });
        ...
        submitWithdrawBtn.addEventListener('click', async () => {
            if (!isWithdrawTime()) {
                iziToast.error({ 
                    ...
                    message: 'Los retiros solo estÃ¡n disponibles de 10:00 PM a 11:30 PM (hora Cuba).' 
                });
                return;
            }
            ...
            if (!methodId || isNaN(amount) || amount <= 0) {
                iziToast.warning({ message: 'Selecciona mÃ©todo e ingresa un monto vÃ¡lido' });
                return;
            }
            ...
            if (method.min_amount !== null && amount < method.min_amount) {
                iziToast.warning({ message: `Monto mÃ­nimo: ${method.min_amount} ${currency}` });
                return;
            }
            if (method.max_amount !== null && amount > method.max_amount) {
                iziToast.warning({ message: `Monto mÃ¡ximo: ${method.max_amount} ${currency}` });
                return;
            }

            // Recoger datos de cuenta segÃºn el tipo
            let accountInfo = '';
            if (currency === 'USDT' || currency === 'TRX') {
                ...
                if (!wallet || !network) {
                    iziToast.warning({ message: 'Debes ingresar direcciÃ³n de wallet y red' });
                    return;
                }
                ...
                accountInfo = `Tarjeta: ${card} | ConfirmaciÃ³n: ${confirm}`;
            }
        ...
        document.getElementById('submitTransferBtn').addEventListener('click', async () => {
            ...
            if (!targetInput || isNaN(amount) || amount <= 0) {
                iziToast.warning({ message: 'Ingresa un usuario vÃ¡lido y un monto positivo' });
                return;
            }
        ...
        async function renderSessionsView() {
            ...
            let html = `<h4 class="text-xl font-semibold mb-4">ðŸŽ° GestiÃ³n de Sesiones</h4>`;
            for (const [lottery, slots] of Object.entries(LOTTERY_SCHEDULES)) {
                ...
                for (const slot of slots) {
                    ...
                    if (session) {
                        if (session.status === 'open') { estado = 'âœ… ACTIVA'; clase = 'status-active'; accion = 'Cerrar'; }
                        else { estado = 'ðŸ”´ CERRADA'; clase = 'status-closed'; accion = 'Abrir'; }
                    } else { estado = 'âšª INACTIVA'; clase = 'status-inactive'; accion = 'Abrir'; }
            ...
            html += `<button onclick="renderSessionsView()" class="mt-2 bg-blue-600 px-4 py-2 rounded-xl text-sm">ðŸ”„ Actualizar</button>`;
        ...
        window.toggleSession = async (lottery, timeSlot, sessionId, currentStatus) => {
            if (sessionId) {
                ...
                try {
                    ...
                    if (res.ok) {
                        iziToast.success({ message: `SesiÃ³n ${newStatus==='open'?'abierta':'cerrada'}` });
                        renderSessionsView();
                    } else {
                        const err = await res.json();
                ...
                try {
                    ...
                    if (res.ok) {
                        iziToast.success({ message: `SesiÃ³n de ${lottery} (${timeSlot}) abierta` });
                        renderSessionsView();
                    } else {
                        const err = await res.json();
                        iziToast.error({ message: err.error });
        ...
        async function renderPublishWinningView() {
            try {
                ...
                let html = `<h4 class="text-xl font-semibold mb-4">ðŸ”¢ Publicar nÃºmeros ganadores</h4><p class="mb-2 text-sm text-yellow-300">âš ï¸ 7 dÃ­gitos (centena+cuarteta). Puedes separar con espacio: 123 4567</p>`;
                if (sessions.length === 0) html += '<p class="text-gray-400">No hay sesiones cerradas.</p>';
                    ...
                    sessions.forEach(s => {
                        ...
                        html += `<div class="bg-gray-800/70 p-4 rounded-xl flex justify-between items-center mb-2"><div><span class="font-bold">${s.lottery} ${s.time_slot}</span><span class="text-sm ml-2">${s.date}</span>${isPublished?'<span class="ml-2 text-green-400">âœ… publicado</span>':''}</div>`;
                        if (!isPublished) html += `<button onclick="publishWinning(${s.id})" class="bg-teal-600 px-4 py-2 rounded-lg">ðŸ“¢ Publicar</button>`;
                        else html += `<button onclick="showWinners(${s.id})" class="bg-blue-600 px-4 py-2 rounded-lg">ðŸ‘ï¸ Ver ganadores</button>`;
                        html += `</div>`;
                    });
                }
                adminViewContainer.innerHTML = html;
        ...
        window.publishWinning = async (sessionId) => {
            const number = prompt('NÃºmero ganador de 7 DÃGITOS (puedes separar con espacio, ej: 517 3262):');
            if (!number) return;
            const clean = number.replace(/\s+/g, '');
            if (!/^\d{7}$/.test(clean)) { iziToast.error({ message: 'Debe tener 7 dÃ­gitos' }); return; }
            try {
                ...
                if (res.ok) {
                    iziToast.success({ message: 'âœ… NÃºmeros publicados. Los ganadores recibirÃ¡n notificaciÃ³n.' });
        ...
        window.showWinners = async (sessionId) => {
            try {
                ...
                const data = await res.json();
                let modalContent = `<h4 class="text-xl font-bold mb-4">ðŸ† Ganadores de la sesiÃ³n</h4>`;
                if (!data.winning_number) {
                    modalContent += `<p class="text-yellow-300">AÃºn no se ha publicado nÃºmero ganador.</p>`;
                } else {
                    ...
                    modalContent += `<p class="mb-3">ðŸ”¢ NÃºmero ganador: <span class="font-mono bg-gray-900 px-2 py-1 rounded">${formattedNumber}</span></p>`;
                    if (data.winners.length === 0) {
                        modalContent += `<p class="text-gray-400">No hubo ganadores en esta sesiÃ³n.</p>`;
                    } else {
        ...
        function renderAddDepositView() {
            adminViewContainer.innerHTML = `
                <h4 class="text-xl font-semibold mb-4">âž• AÃ±adir mÃ©todo de DEPÃ“SITO</h4>
                ...
                <input type="text" id="depCard" placeholder="NÃºmero de tarjeta / wallet" class="w-full p-3 rounded-xl bg-gray-800 text-white border border-cyan-500 mb-3">
                <input type="text" id="depConfirm" placeholder="NÃºmero a confirmar / red" class="w-full p-3 rounded-xl bg-gray-800 text-white border border-cyan-500 mb-3">
                ...
                <input type="number" id="depMinAmount" placeholder="LÃ­mite mÃ­nimo (0 = sin lÃ­mite)" step="0.01" min="0" class="w-full p-3 rounded-xl bg-gray-800 text-white border border-cyan-500 mb-3">
                <input type="number" id="depMaxAmount" placeholder="LÃ­mite mÃ¡ximo (0 = sin lÃ­mite)" step="0.01" min="0" class="w-full p-3 rounded-xl bg-gray-800 text-white border border-cyan-500 mb-3">
            ...
            document.getElementById('saveDepositMethodBtn')?.addEventListener('click', async () => {
                ...
                try {
                    ...
                    if (res.ok) { iziToast.success({ message: 'MÃ©todo aÃ±adido' }); await loadDepositMethods(); renderViewDataView(); }
        ...
        function renderAddWithdrawView() {
            adminViewContainer.innerHTML = `
                <h4 class="text-xl font-semibold mb-4">âž• AÃ±adir mÃ©todo de RETIRO</h4>
                ...
                <input type="text" id="witCard" placeholder="InstrucciÃ³n/nÃºmero (ej: nÃºmero de tarjeta)" class="w-full p-3 rounded-xl bg-gray-800 text-white border border-pink-500 mb-3">
                <input type="text" id="witConfirm" placeholder="NÃºmero a confirmar / red" class="w-full p-3 rounded-xl bg-gray-800 text-white border border-pink-500 mb-3">
                ...
                <input type="number" id="witMinAmount" placeholder="LÃ­mite mÃ­nimo (0 = sin lÃ­mite)" step="0.01" min="0" class="w-full p-3 rounded-xl bg-gray-800 text-white border border-pink-500 mb-3">
                <input type="number" id="witMaxAmount" placeholder="LÃ­mite mÃ¡ximo (0 = sin lÃ­mite)" step="0.01" min="0" class="w-full p-3 rounded-xl bg-gray-800 text-white border border-pink-500 mb-3">
            ...
            document.getElementById('saveWithdrawMethodBtn')?.addEventListener('click', async () => {
                ...
                if (!name || !card) { iziToast.warning({ message: 'Nombre e instrucciÃ³n obligatorios' }); return; }
                try {
                    ...
                    if (res.ok) { iziToast.success({ message: 'MÃ©todo aÃ±adido' }); await loadWithdrawMethods(); renderViewDataView(); }
                    else { const err = await res.json(); iziToast.error({ message: err.error }); }
                } catch (e) { iziToast.error({ message: 'Error de conexiÃ³n' }); }
            });
        }
        ...
        async function renderEditDepositView() {
            try {
                ...
                let html = `<h4 class="text-xl font-semibold mb-4">âœï¸ Editar mÃ©todo de DEPÃ“SITO</h4>`;
                if (methods.length === 0) {
                    html += `<p class="text-gray-400">No hay mÃ©todos.</p>`;
                } else {
                    methods.forEach(m => {
                        html += `<div class="bg-gray-800/70 p-3 rounded-xl mb-2 flex justify-between items-center">
                            <div><span class="font-bold">${escapeHTML(m.name)}</span><br><small>${escapeHTML(m.card)} / ${escapeHTML(m.confirm)} (${m.currency}) MÃ­n: ${m.min_amount !== null ? m.min_amount : '-'} MÃ¡x: ${m.max_amount !== null ? m.max_amount : '-'}</small></div>
                ...
                console.error(e);
                adminViewContainer.innerHTML = '<p class="text-red-400">Error al cargar mÃ©todos. Verifique la conexiÃ³n con el backend.</p>';
            }
        }
        ...
        window.openEditDepositModal = async (methodId) => {
            try {
                ...
                modalBody.innerHTML = `
                    <h4 class="text-xl font-bold mb-4">Editar DepÃ³sito ID ${methodId}</h4>
                    <label>Nombre</label>
                    ...
                    <label>LÃ­mite mÃ­nimo (0 = sin lÃ­mite)</label>
                    ...
                    <label>LÃ­mite mÃ¡ximo (0 = sin lÃ­mite)</label>
                ...
                console.error(e);
                iziToast.error({ message: 'Error al cargar mÃ©todo' });
            }
        };
        ...
        window.saveEditDeposit = async (methodId) => {
            ...
            try {
                ...
                if (res.ok) {
                    iziToast.success({ message: 'MÃ©todo actualizado' });
        ...
        async function renderEditWithdrawView() {
            try {
                ...
                if (!res.ok) throw new Error(`HTTP ${res.status}`);
                const methods = await res.json();
                let html = `<h4 class="text-xl font-semibold mb-4">âœï¸ Editar mÃ©todo de RETIRO</h4>`;
                if (methods.length === 0) {
                    html += `<p class="text-gray-400">No hay mÃ©todos.</p>`;
                } else {
                    methods.forEach(m => {
        ...
        window.saveEditWithdraw = async (methodId) => {
            ...
            if (!name || !card) { iziToast.warning({ message: 'Nombre e instrucciÃ³n son obligatorios' }); return; }
            try {
        ...
        async function renderDeleteDepositView() {
            try {
                ...
                if (!res.ok) throw new Error(`HTTP ${res.status}`);
                const methods = await res.json();
                let html = `<h4 class="text-xl font-semibold mb-4">ðŸ—‘ Eliminar mÃ©todo de DEPÃ“SITO</h4>`;
                if (methods.length === 0) {
                    html += `<p class="text-gray-400">No hay mÃ©todos.</p>`;
                } else {
                    methods.forEach(m => {
                ...
                console.error(e);
                adminViewContainer.innerHTML = '<p class="text-red-400">Error al cargar mÃ©todos.</p>';
            }
        }

        window.deleteDepositMethod = async (methodId) => {
            if (!confirm('Â¿EstÃ¡s seguro de eliminar este mÃ©todo?')) return;
            try {
                const res = await fetch(`/api/admin/deposit-methods/${methodId}?userId=${currentUser.telegram_id}`, {
                    method: 'DELETE'
                });
                if (res.ok) {
                    iziToast.success({ message: 'MÃ©todo eliminado' });
                    await loadDepositMethods();
        ...
        async function renderDeleteWithdrawView() {
            try {
                ...
                if (!res.ok) throw new Error(`HTTP ${res.status}`);
                const methods = await res.json();
                let html = `<h4 class="text-xl font-semibold mb-4">ðŸ—‘ Eliminar mÃ©todo de RETIRO</h4>`;
                if (methods.length === 0) {
                    html += `<p class="text-gray-400">No hay mÃ©todos.</p>`;
                } else {
                    methods.forEach(m => {
        ...
        function renderSetRateView() {
            adminViewContainer.innerHTML = `
                <h4 class="text-xl font-semibold mb-4">ðŸ’° Configurar Tasas de Cambio</h4>
            ...
            document.getElementById('updateRateUSDBtn')?.addEventListener('click', async () => {
                ...
                if (isNaN(rate) || rate <= 0) { iziToast.warning({ message: 'Tasa invÃ¡lida' }); return; }
                try {
        ...
        async function renderSetPricesView() {
            try {
                ...
                let html = `<h4 class="text-xl font-semibold mb-4">ðŸŽ² Pagos, MÃ­nimos y MÃ¡ximos</h4>`;
                prices.forEach(p => {
                    html += `<div class="mb-6 bg-gray-800/50 p-4 rounded-xl">
                        ...
                        <div class="mb-3 p-3 bg-gray-700/30 rounded-lg">
                            <p class="text-sm font-semibold text-yellow-300 mb-2">ðŸŽ PAGO (MULTIPLICADOR)</p>
                        ...
                        <div class="p-3 bg-gray-700/30 rounded-lg">
                            <p class="text-sm font-semibold text-gray-300 mb-2">ðŸ“‰ MONTOS MÃNIMOS</p>
                            ...
                            <p class="text-sm font-semibold text-gray-300 mb-2">ðŸ“ˆ MONTOS MÃXIMOS</p>
        ...
        window.updatePlayPrice = async (betType) => {
            ...
            if (isNaN(multiplier) || isNaN(minCup) || isNaN(minUsd) || isNaN(maxCup) || isNaN(maxUsd) || multiplier < 0 || minCup < 0 || minUsd < 0 || maxCup < 0 || maxUsd < 0) {
                iziToast.warning({ message: 'Valores invÃ¡lidos' }); return;
            }
            try {
                ...
                if (res.ok) {
                    iziToast.success({ message: 'Pagos, mÃ­nimos y mÃ¡ximos actualizados' });
        ...
        async function renderViewDataView() {
            try {
                ...
                text += `ðŸ“¥ <b>MÃ©todos DEPÃ“SITO:</b>\n`;
                depMethods.forEach(m => text += `  â€¢ ${m.name} (${m.currency}) - ${m.card} / ${m.confirm} | MÃ­n: ${m.min_amount !== null ? m.min_amount : '-'} | MÃ¡x: ${m.max_amount !== null ? m.max_amount : '-'}\n`);
                text += `\nðŸ“¤ <b>MÃ©todos RETIRO:</b>\n`;
                witMethods.forEach(m => text += `  â€¢ ${m.name} (${m.currency}) - ${m.card} / ${m.confirm} | MÃ­n: ${m.min_amount !== null ? m.min_amount : '-'} | MÃ¡x: ${m.max_amount !== null ? m.max_amount : '-'}\n`);
                text += `\nðŸŽ² <b>Pagos, MÃ­nimos y MÃ¡ximos por jugada:</b>\n`;
                prices.forEach(p => text += 
                    `  â€¢ ${p.bet_type}: Pago x${p.payout_multiplier || 0}  |  MÃ­n: ${p.min_cup||0} CUP / ${p.min_usd||0} USD  |  MÃ¡x: ${p.max_cup||'âˆž'} CUP / ${p.max_usd||'âˆž'} USD\n`
                );
        ...
        async function renderPendingRequestsView() {
            let html = `
                <h4 class="text-xl font-semibold mb-4">â³ Solicitudes Pendientes</h4>
                <div class="tab-buttons">
                    <div class="tab-button active" data-tab="deposits">DepÃ³sitos</div>
            ...
            async function loadTab(tab) {
                ...
                if (tab === 'deposits') {
                    try {
                        ...
                        if (!res.ok) throw new Error('Error al cargar depÃ³sitos');
                        const deposits = await res.json();
                        if (deposits.length === 0) {
                            tabContent.innerHTML = '<p class="text-gray-400 text-center py-4">No hay solicitudes de depÃ³sito pendientes.</p>';
                        } else {
                            let listHtml = '';
                            deposits.forEach(d => {
                                listHtml += `
                                    <div class="pending-item" id="deposit-${d.id}">
                                        <div class="flex justify-between items-start">
                                            <div>
                                                ...
                                                <p><strong>MÃ©todo:</strong> ${escapeHTML(d.method_name)}</p>
                                                <p><strong>Captura:</strong> <a href="${d.screenshot_url}" target="_blank" class="text-cyan-400">Ver</a></p>
                                            </div>
                                            <div class="flex gap-2">
                                                <button onclick="handlePending('deposit', ${d.id}, 'approve')" class="bg-green-600 px-3 py-1 rounded-lg text-sm">âœ… Aprobar</button>
                                                <button onclick="handlePending('deposit', ${d.id}, 'reject')" class="bg-red-600 px-3 py-1 rounded-lg text-sm">âŒ Rechazar</button>
                                            </div>
                                        </div>
                                    </div>
                                `;
                        ...
                        console.warn('Error cargando depÃ³sitos pendientes:', e);
                        tabContent.innerHTML = `
                            <p class="text-yellow-300 mb-3">âš ï¸ Endpoint no disponible. Mostrando datos de ejemplo:</p>
                            <div class="pending-item">
                                <div class="flex justify-between">
                                    <div><strong>Usuario:</strong> Juan PÃ©rez (12345)<br><strong>Monto:</strong> 500 CUP<br><strong>MÃ©todo:</strong> Transferencia Bancaria</div>
                                    <div class="flex gap-2"><button class="bg-green-600 px-3 py-1 rounded-lg">âœ… Aprobar</button><button class="bg-red-600 px-3 py-1 rounded-lg">âŒ Rechazar</button></div>
                                </div>
                            </div>
                            <div class="pending-item">
                                <div class="flex justify-between">
                                    <div><strong>Usuario:</strong> MarÃ­a GÃ³mez (67890)<br><strong>Monto:</strong> 20 USDT<br><strong>MÃ©todo:</strong> USDT (TRC-20)</div>
                                    <div class="flex gap-2"><button class="bg-green-600 px-3 py-1 rounded-lg">âœ… Aprobar</button><button class="bg-red-600 px-3 py-1 rounded-lg">âŒ Rechazar</button></div>
                                </div>
                            </div>
                        `;
                    ...
                    try {
                                    ...
                                    <div class="pending-item" id="withdraw-${w.id}">
                                        <div class="flex justify-between items-start">
                                            <div>
                                                ...
                                                <p><strong>MÃ©todo:</strong> ${escapeHTML(w.method_name)}</p>
                                                <p><strong>Cuenta:</strong> ${escapeHTML(w.account_info)}</p>
                                            </div>
                                            <div class="flex gap-2">
                                                <button onclick="handlePending('withdraw', ${w.id}, 'approve')" class="bg-green-600 px-3 py-1 rounded-lg text-sm">âœ… Aprobar</button>
                                                <button onclick="handlePending('withdraw', ${w.id}, 'reject')" class="bg-red-600 px-3 py-1 rounded-lg text-sm">âŒ Rechazar</button>
                                            </div>
                                        </div>
                                    </div>
                                `;
                        ...
                        tabContent.innerHTML = `
                            ...
                            <div class="pending-item">
                                <div class="flex justify-between">
                                    <div><strong>Usuario:</strong> Carlos Ruiz (54321)<br><strong>Monto:</strong> 50 USD<br><strong>MÃ©todo:</strong> PayPal<br><strong>Cuenta:</strong> carlos@email.com</div>
                                    <div class="flex gap-2"><button class="bg-green-600 px-3 py-1 rounded-lg">âœ… Aprobar</button><button class="bg-red-600 px-3 py-1 rounded-lg">âŒ Rechazar</button></div>
                                </div>
                            </div>
                        `;
        ...
        window.handlePending = async (type, id, action) => {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    // Recargar la pestaÃ±a activa
                    const activeTab = document.querySelector('.tab-button.active').dataset.tab;
                    const pendingTabContent = document.getElementById('pendingTabContent');
                    // Simular recarga de la pestaÃ±a llamando a loadTab
                    const tabButtons = document.querySelectorAll('.tab-button');
                    const loadTab = async (tab) => {
                        // Re-ejecutar la lÃ³gica de renderPendingRequestsView simplificada
            ...
            if (!globalLoader.classList.contains('hidden')) {
                globalLoader.innerHTML = `
                    <div class="error-box">
                        ...
                        <p class="text-sm mb-4">El servidor no responde. Verifica tu conexiÃ³n o intÃ©ntalo mÃ¡s tarde.</p>
                        <button onclick="location.reload()" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-xl">
                            <i class="fas fa-sync-alt mr-2"></i>Reintentar
                        </button>
                    </div>
